 ...
 */
class NetworkTreeEditPart extends AbstractTreeEditPart
 ...
 */
NetworkTreeEditPart(NetworkElement model) {
	super(model);
}
...
private NetworkElement getCastedModel() {
	return (NetworkElement) getModel();
}
...
protected Image getImage() {
	return NetworkEditorPaletteFactory.networkIcon.createImage();
}
...
protected String getText() {
	return Messages.getString("ru.bmstu.iu5.opsk.gef.model.network.name"); //$NON-NLS-1$
}
